...
export default function HCGIMTrackerPage() {
    ...
    const images = [
      { url: "https://github.com/schen044/minesweeper/raw/main/images/midgame.png" },
      { url: "https://github.com/schen044/minesweeper/raw/main/images/win.png" },
      { url: "https://github.com/schen044/minesweeper/raw/main/images/lose.png" },
    ];
    return (
        <div>
